...
<head>
    ...
    * {
    ...
    .contenedor {
        ...
        /* Centrar si hay menos elementos */
        gap: 10px;
    ...
    @media (max-width: 600px) {
        .caja {
            flex-basis: 100%;
            /* En pantallas pequeñas, ocupan todo el ancho */
        }
    }
    </style>
</head>
...
--->
    ...
    <!--<div id="miModal" class="modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-contenido">
                ...
                <div class="modal-form-close cerrar" id="btnCerrarModal">
                    <img src="<?= base_url() ?>frontend/images/close.svg" alt="Close">
                </div>


                <div class="modal-body">
                    <div class="modal-form-title">Directorio - Detalle</div>
        ...
        <div class="swiper banner-swiper">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide"
                    style="background-image: url(<?= base_url() ?>frontend/images/galeria/carrucel/img3.jpg)">
                    <div class="banner-content">
                        <div class="banner-subtitle wow fadeIn" data-wow-delay="0.1s">Personal comprometido</div>
                        <h2 class="banner-title wow fadeIn" data-wow-delay="0.2s"><strong>Personal</strong> comprometido
                            al cuidado de cada detalle</h2>
                        <a href="#s-services" class="banner-btn def-btn anchor-link wow fadeIn"
                            data-wow-delay="0.3s">Ver Servicios</a>
                    </div>
                </div>
                <!--<div class="swiper-slide" style="background-image: url(<?= base_url() ?>frontend/images/banner-bg-2.jpg)">-->
                <div class="swiper-slide"
                    style="background-image: url(<?= base_url() ?>frontend/images/galeria/carrucel/img2.jpg)">
                    <div class="banner-content">
                        <div class="banner-subtitle wow fadeIn">Personal comprometido</div>
                        <h2 class="banner-title"><strong>Servicio y mantenimiento</strong> de interiores y exteriores
                        </h2>
                ...
                <div class="swiper-slide"
                    style="background-image: url(<?= base_url() ?>frontend/images/galeria/carrucel/img1.jfif)">
                    <div class="banner-content">
                        <div class="banner-subtitle">Personal comprometido</div>
                        <h2 class="banner-title"><strong>Construcción de casas</strong> Construiremos una casa de
                            calidad</h2>
                        <a href="#s-services" class="banner-btn def-btn anchor-link">Ver servicios</a>
                    </div>
                </div>
            ...
            <div class="about-row">
                <div class="about-left">
                    ...
                    <div class="def-desc wow fadeInLeft" data-wow-delay="0.3s">
                        Somos personas comprometidas en temas de construcción, trabajamos profesionalmente desde el
                        inicio del proyecto en papel hasta la implementación en el lugar, al colaborar con nosotros
                        puedes tener la confianza y seguridad de que nos encargaremos de realizar cada pensamiento e
                        ideas para darles vida en cada espacio y etapas del proyecto.
                    </div>
                    <a href="#s-services" class="def-btn anchor-link wow fadeInLeft" data-wow-delay="0.4s">Otros
                        servicios</a>
                </div>

                <div class="about-right">
                    <img src="<?= base_url() ?>frontend/images/galeria/techos/img3.jpeg" alt="О нас" class="wow fadeIn"
                        data-wow-delay="0.5s">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="services-row">
                ...
                <div class="services-item wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <div class="services-body">
                        ...
                        <div class="services-desc">
                            Experimente el arte de la construcción de viviendas con nuestros expertos en servicios de
                            construcción desde inicio hasta el final del proyecto.
                        </div>
                        <a href="#modal-form" data-effect="mfp-zoom-in" class="def-btn services-btn">Servicio de
                            pedidos</a>
                    </div>
                </div>
                ...
                <div class="services-item wow fadeIn" data-wow-delay="0.2s">
                    ...
                    <div class="services-body">
                        ...
                        <div class="services-desc">
                            Eleve su espacio vital con nuestros servicios de manteminiento de viviendas de primer nivel.
                            Ya sea que se trate de mejoras sutiles o completas.
                        </div>
                        <a href="#modal-form2" data-effect="mfp-zoom-in" class="def-btn services-btn">Servicio de
                            pedidos</a>
                    </div>
                </div>
                ...
                <div class="services-item wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div class="services-body">
                        ...
                        <div class="services-desc">
                            Libere el potencial del diseño innovador con nuestros servicios integrales de planificación
                            de mejoramientos de espacios.
                        </div>
                        <a href="#modal-form3" data-effect="mfp-zoom-in" class="def-btn services-btn">Servicio de
                            pedidos</a>
                    </div>
                </div>
            </div><br>
            ...
            <div class="services-row">
                ...
                <div class="services-item wow fadeIn" data-wow-delay="0.1s">
                    <div class="services-thumb">
                        <!--<img src="<?= base_url() ?>frontend/images/service-1.jpg" alt="Construction of houses">-->
                        <img src="<?= base_url() ?>frontend/images/galeria/panel-solar/img1.jpg"
                            alt="Construction of houses">
                    </div>
                    <div class="services-body">
                        <h4 class="services-title">Instalación de panel solar</h4>
                        <div class="services-desc">
                            Utilice la energía solar como la nueva alternativa de consumo para su hogar o negocio,
                            cuidando siempre con responsabilidad el medio ambiente, ante el impacto generado por la
                ...
                <div class="services-item wow fadeIn" data-wow-delay="0.2s">
                    <div class="services-thumb">
                        <!--<img src="<?= base_url() ?>frontend/images/service-1.jpg" alt="Construction of houses">-->
                        <img src="<?= base_url() ?>frontend/images/galeria/panel-solar/img3.jpg"
                            alt="Construction of houses">
                    </div>
                    <div class="services-body">
                        <h4 class="services-title">Instalación de calentador solar</h4>
                        <div class="services-desc">
                            DE LEON-CONSTRUCCIÓN ofrece la instalación de calentadores solares, este sistema mantendra
                            el agua caliente solamente con la energía solar, sin la necesidad de gas o lectricidad.
                        </div>
                        <a href="#modal-form" data-effect="mfp-zoom-in" class="def-btn services-btn">Servicio de
                            pedidos</a>
                    </div>
    ...
    <section class="s-gallery" id="s-gallery">
        <div class="container">
            ...
            <div class="gallery-wrap">
                <a href="<?= base_url() ?>frontend/images/galeria/general/img16.jpg" class="gallery-item wow fadeIn"
                    data-effect="mfp-zoom-in" data-wow-delay="0.2s">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img16.jpg" alt="Image 1">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img17.jpg" class="gallery-item wow fadeIn"
                    data-effect="mfp-zoom-in" data-wow-delay="0.3s">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img17.jpg" alt="Image 2">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img18.jpg" class="gallery-item wow fadeIn"
                    data-effect="mfp-zoom-in" data-wow-delay="0.4s">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img18.jpg" alt="Image 3">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img26.jpg" class="gallery-item wow fadeIn"
                    data-effect="mfp-zoom-in" data-wow-delay="0.5s">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img26.jpg" alt="Image 4">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img24.jpg" class="gallery-item wow fadeIn"
                    data-effect="mfp-zoom-in" data-wow-delay="0.6s">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img24.jpg" alt="Image 5">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img25.jpg" class="gallery-item wow fadeIn"
                    data-effect="mfp-zoom-in" data-wow-delay="0.6s">
                    <span class="gallery-border"></span>
                ...
                <!--/** Ver más y ocultar*/-->
                <a href="<?= base_url() ?>frontend/images/galeria/general/img21.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img21.jpg" alt="Image 6">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img20.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img20.jpg" alt="Image 7">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img27.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img27.jpg" alt="Image 9">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/techos/img6.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/techos/img6.jpg" alt="Image 10">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/techos/img8.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/techos/img8.jpg" alt="Image 11">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/techos/img11.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/techos/img11.jpg" alt="Image 12">
                </a>

                <a href="<?= base_url() ?>frontend/images/galeria/general/img31.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img31.jpg" alt="Image 10">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img32.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img32.jpg" alt="Image 11">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img33.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img33.jpg" alt="Image 12">
                </a>

                <a href="<?= base_url() ?>frontend/images/galeria/cisterna/img3.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/cisterna/img3.jpg" alt="Image 10">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/cisterna/img4.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/cisterna/img4.jpg" alt="Image 11">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/cisterna/img5.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/cisterna/img5.jpg" alt="Image 12">
                </a>

                <a href="<?= base_url() ?>frontend/images/galeria/general/img34.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img34.jpg" alt="Image 10">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img35.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img35.jpg" alt="Image 11">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/general/img36.jpg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/general/img36.jpg" alt="Image 12">
                </a>

                <a href="<?= base_url() ?>frontend/images/galeria/panel-solar/img4.jpeg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/panel-solar/img4.jpeg" alt="Image 10">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/panel-solar/img5.jpeg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
                    <img src="<?= base_url() ?>frontend/images/galeria/panel-solar/img5.jpeg" alt="Image 11">
                </a>
                <a href="<?= base_url() ?>frontend/images/galeria/panel-solar/img6.jpeg" class="gallery-item"
                    data-effect="mfp-zoom-in">
                    <span class="gallery-border"></span>
            ...
            <div class="why-row">
                ...
                <div class="why-left">
                    ...
                    <div class="def-desc wow fadeInLeft" data-wow-delay="0.2s">
                        Somos personas responsables. <br> Culminamos tus proyectos en tiempo real, brindandote los
                        mejores acabados y calidad en construcción.
                    </div>
                    ...
                    <div class="why-features">
                        ...
                        <div class="why-features-item">
                            ...
                            <div class="why-features-right">
                                <div class="why-features-title wow fadeInRight" data-wow-delay="0.4s">Calidad de trabajo
                                </div>
                                <div class="why-features-desc wow fadeInRight" data-wow-delay="0.5s">
                                    Durante 5 años de trabajo, hemos desarrollado diferentes tipos de trabajos en
                                    contrucción y todo tipo de acabados en obras
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="why-features-item">
                            ...
                            <div class="why-features-right">
                                <div class="why-features-title wow fadeInRight" data-wow-delay="0.4s">Construcción
                                    moderna</div>
                                <div class="why-features-desc wow fadeInRight" data-wow-delay="0.5s">
                                    Elegir nuestro equipo de trabajo significa optar por tecnologías de vanguardia y
                                    fiabilidad. Nuestra experiencia y profesionalidad aseguran la construcción.
                                </div>
                            </div>
                        </div>
                ...
                <div class="why-right">
                    ...
                    <img src="<?= base_url() ?>frontend/images/galeria/techos/img4.jpeg" alt="¿Por qué nosotros?"
    ...
    <section class="s-reviews" id="s-team"
        style="background-image: url('<?= base_url() ?>frontend/images/reviews-bg.png');">
    ...
    <section class="s-team" id="s-busqueda">
        ...
        <div class="container">
            ...
            <div class="def-desc wow fadeInLeft" data-wow-delay="0.3s">
                DE LEÓN-CONSTRUCCIÓN cuenta con un motor de búsqueda para consultar la información de personas dedicadas
                a los oficios referentes a la construcción y poder dar solución a los pequeños y grandes proyectos.
                Puedes buscar y solicitar los servicios de un fontanero, albañil, herrero, etc., que se encuentran cerca
                de tu domicilio.
            </div><br>
        ...
        <div class="container">
            <div class="form-row">
                ...
                <div class="form-left">
                    ...
                    <div class="def-desc">
                        Si tiene alguna pregunta o desea solicitar nuestros servicios, complete el formulario de la
                        derecha. Estamos las 24 horas del día y le devolveremos la llamada durante el día.
                    </div>
            ...
            <div class="footer-row">
                ...
                <div class="footer-left">
                    ...
                    <div class="footer-desc">
                        <strong>Construcción</strong> Mantenimiento, reparaciones, diseños y acabados en construcción
                        completo.
                    </div>
                </div>
                ...
                <div class="footer-right">
                    ...
                    <div class="footer-nav">
                        ...
                        <a href="tel:3330252158" class="footer-info-item">
                            <div class="footer-info-icon"><img src="<?= base_url() ?>frontend/images/phone-gray.svg"
                                    alt="Phone"></div>
